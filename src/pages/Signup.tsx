...
const Signup = () => {
  ...
  const getAuthRedirectUrl = () => {
    ...
    return origin.includes("id-preview--") ? "https://synthi-build-hub.lovable.app" : origin;
  };
  ...
  const strengthLabels = ["8+ characters", "Uppercase", "Lowercase", "Number", "Symbol"];
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-4 relative">
      ...
      <Card className="w-full max-w-md clay-card p-4 shadow-2xl relative z-10 animate-slide-in-right">
        <CardHeader className="text-center">
          ...
          <CardDescription>Start building with AI agents</CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <CardFooter className="justify-center mt-2">
          <p className="text-sm text-muted-foreground">
            ...
            <Link to="/login" className="text-primary hover:text-primary/70 font-semibold transition-colors">
              Sign in
            </Link>
          </p>
        </CardFooter>
